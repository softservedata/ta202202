...
public class ApplStream2 {
	...
	public static void main(String[] args) {
		...
		*/
		/*-
		// Arrays.asList(new Integer[] {3, 2, 2, 3, 7, 3, 5});
		...
		*/
		// /*-
		List<String> strings1 = Arrays.asList("abc", "", "bc", "eg");
		List<String> strings2 = Arrays.asList( "eg", "abd1", "", null, "jkl");
		List<String> common = Stream.of(strings1.stream(), strings2.stream())
